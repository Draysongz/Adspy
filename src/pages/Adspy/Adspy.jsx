...
const Adspy = () => {
    ...
    const handleSearchAds = () => {
      ...
      const apiKey = 'EAAEscRYLMj8BO4ZAPystMBQylzOw0UqZBIg4ftCZCiHCZAZBj0PZB0CirrVWHGzo9y1emIXApMcK5WPHZBgtBndFNk76e3WkTUHsMVxVrKdBZAXIJ39f9QeFoF2jXvSXaoN0H31Bjb6Pqd6VNOcTUi0T8cVLOjO7PKO7QyT1WdZAzLDTduvte3LMnPtZCGz6da8G8MrNuPLctv'
      const queryParams = {
      ...
      useEffect(() => {
        ...
        const getPageNameForUrl = async (adSnapshotUrl) => {
          ...
          const fetchPageNames = async (adSnapshotUrls) => {
            const pageNamePromises = adSnapshotUrls?.map(adSnapshotUrl => getPageNameForUrl(adSnapshotUrl));
...
<Flex justifyContent={'center'} mt={10} direction={'column'} gap={10}>
  ...
  <TabList    justifyContent={'center'}>
    ...
    <Tab onClick={() => setPlatform('facebook')} borderRadius={'md'} _selected={{ color: 'white', bg: 'blue.500' }}>
        <HStack spacing={3}>
        <Image borderRadius={'md'} src={'/fb.svg'} alt='meta' width={'5'} />
        <Text fontSize={'lg'}>Facebook</Text>
        </HStack>
        </Tab>
        <Tab borderRadius={'md'} _selected={{ color: 'white', bg: 'blue.500' }}>
        <HStack>
        <Image borderRadius={'md'} src={'/IG.svg'} alt='meta' width={'5'} />
        <Text fontSize={'lg'}>Instagram</Text>
        </HStack>
        </Tab>
        <Tab borderRadius={'md'} _selected={{ color: 'white', bg: 'blue.500' }}>
        <HStack>
        <Image borderRadius={'md'} src={'/twitter.svg'} alt='meta' width={'5'} />
        ...
        <Tab borderRadius={'md'} _selected={{ color: 'white', bg: 'blue.500' }}>
        <HStack>
        <Image borderRadius={'md'} src={'/youtube.svg'} alt='meta' width={'5'} />
...
{countryOptions}
      ...
      <Flex gap={5} justifyContent={'center'} mt={4}> 
        ...
        <Button borderRadius={'md'} h={'7vh'} onClick={clearAll}
